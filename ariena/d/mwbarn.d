...
END
IF ~Global("Arinumkic","GLOBAL",0)~ THEN REPLY @126 DO ~ReputationInc(-1)~ EXTERN ArienaP 0
IF ~Global("Arinumkic","GLOBAL",1)~ THEN REPLY @126 DO ~ReputationInc(-1)~ EXTERN ArienaP 2
...
== MWBArn @130
END
IF ~Global("Arinumkic","GLOBAL",0)~ THEN REPLY @131 DO ~ReputationInc(-1)~ EXTERN ArienaP 0
IF ~Global("Arinumkic","GLOBAL",1)~ THEN REPLY @131 DO ~ReputationInc(-1)~ EXTERN ArienaP 2
